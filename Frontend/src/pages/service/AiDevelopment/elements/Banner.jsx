  ...
  return (
    <>
      ...
      >
        <div className="h-screen container mx-auto flex flex-col justify-center lg:justify-end items-center">
          ...
          <div className="h-[400px] lg:h-[400px] w-full flex flex-col justify-center lg:justify-start items-center gap-7 px-4 text-center">
            ...
            <div className="w-full lg:w-[50%] p-2 flex flex-col lg:flex-row justify-center lg:justify-between items-center flex-wrap gap-4">
              <HashLink smooth to={AiDevelopBannerData.link1} className="relative h-[50px] w-[70%] lg:w-[45%] min-w-[140px] rounded-sm flex justify-center items-center text-[var(--text-color)] transition-all duration-300 border hover:text-transparent hover:bg-clip-text text-sm hover:bg-gradient-to-r hover:from-[#006CFF] hover:to-[#00264B] hover:border border-[#006CFF] gap-2 group">
                <span>{link1Text}</span>
      ...
      <div className="container mx-auto my-[100px]">
        <div className="w-[95%] lg:w-[80%] mx-auto flex flex-col justify-center items-center text-center">
          <AnimatedLetters
            text={heading2}
