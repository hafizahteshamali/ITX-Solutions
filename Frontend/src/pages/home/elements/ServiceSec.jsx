  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="lg:h-screen h-[500px] bg-[var(--bg-color)] relative bg-cover bg-center bg-no-repeat overflow-hidden will-change-[transform,opacity]"
      >
        <motion.img
      ...
      <motion.div
        ...
        className="bg-[var(--bg-color)] shadow-2xl py-[70px] will-change-[transform,opacity]"
      >
