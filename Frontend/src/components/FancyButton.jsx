const FancyButton = ({ onClick, type, className, text }) => {
  return (
    <button
      onClick={onClick}
      type={type}
      className={`relative inline-flex items-center justify-center overflow-hidden text-[#1C3C98] bg-white font-bold tracking-wider rounded-full border-2 border-white transition-all duration-300 h-14 lg:h-[50px] px-8 lg:px-0 text-[17px] min-w-[250px] ${className}`}
    >
